...
Темой данной проектной работы является: «Разработка и настройка многофилиальной сети предприятия с применением протоколов L2/L3 и сервисов безопасности». Работа направлена на проектирование адресного пространства, построение логической схемы сети и реализацию набора ключевых сетевых технологий, обеспечивающих корректную маршрутизацию между площадками, централизованное обслуживание пользователей и базовую защиту периметра и сегментов сети.
