...
<img width="614" height="382" alt="image" src="https://github.com/user-attachments/assets/c68ee331-6dee-4814-ab4a-75143c233048" />
<img width="680" height="235" alt="image" src="https://github.com/user-attachments/assets/498df30c-93f6-49ef-acef-fe8af2111d19" />
...
#### Sticky MAC записывается в running-config
#### Он не стареет как динамический, поэтому поле Remaining Age не отображается

### 2.	Что касается безопасности порта на S2, если вы загружаете скрипт текущей конфигурации на S2, почему порту 18 на PC-B никогда не получит IP-адрес через DHCP?
#### Потому что Port Security уже активен, а MAC-адрес хоста ещё не был изучен или не совпадает.

### 3.	Что касается безопасности порта, в чем разница между типом абсолютного устаревания и типом устаревание по неактивности?
#### Absolute - MAC удаляется через заданное время всегда, даже если был трафик
#### Inactivity - MAC удаляется только если не было трафика в течение времени
